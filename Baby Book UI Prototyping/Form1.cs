...
namespace Baby_Book_UI_Prototyping
{
    public partial class Form1 : Form
    {
        ...
        bool loggedin = false;
        DataTable dtmytable;
        string dbfile = @"C:\Users\Mike\Downloads\MyDB.bin";
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "CREATE TABLE mytable (column_name1 varchar(255))";
            db.ExecuteNonQuery(sql);
            sql = "insert into mytable values (\"This is a test!\")";
            db.ExecuteNonQuery(sql);

            sql = "select * from mytable";

            dtmytable = db.GetDataTable(sql);

            dataGridView1.DataSource = dtmytable;
        }
